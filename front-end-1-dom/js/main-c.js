...
for (const picObj of picArray) {
  const newArticle = document.createElement('article');
  const newHeader = document.createElement('header');
  const newHeading = document.createElement('h2');

  newHeading.textContent = picObj.title;
  newHeader.appendChild(newHeading);
  newArticle.appendChild(newHeader);

  const newFigure = document.createElement('figure');
  const newImage = document.createElement('img');
  newImage.setAttribute('src', picObj.filename);
  newImage.setAttribute('alt', picObj.title);

  newFigure.appendChild(newImage);
  const newCaption = document.createElement('figcaption');
  newCaption.textContent = picObj.caption;
  newFigure.appendChild(newCaption);
  newArticle.appendChild(newFigure);

  const newParagraph = document.createElement('p');
  newParagraph.textContent = picObj.description;
